...
# ---[ Solution folders
hypertea_option(USE_PROJECT_FOLDERS "IDE Solution folders" (MSVC_IDE OR CMAKE_GENERATOR MATCHES Xcode) )
...
if(UNIX OR APPLE)
  add_custom_target(symlink_to_build COMMAND "ln" "-sf" "${PROJECT_BINARY_DIR}" "${PROJECT_SOURCE_DIR}/build"
                                     COMMENT "Adding symlink: <hypertea_root>/build -> ${PROJECT_BINARY_DIR}" )
endif()

# ---[ Set debug postfix
set(Hypertea_DEBUG_POSTFIX "-d")

set(Hypertea_POSTFIX "")
if(CMAKE_BUILD_TYPE MATCHES "Debug")
  set(Hypertea_POSTFIX ${Hypertea_DEBUG_POSTFIX})
endif()
